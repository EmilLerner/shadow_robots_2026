...
ur5_joints = [
    ...
    sim.getObject('/UR5/link/joint'),
    sim.getObject('/UR5/link/joint/link/joint'),
    sim.getObject('/UR5/link/joint/link/joint/link/joint'),
    sim.getObject('/UR5/link/joint/link/joint/link/joint/link/joint'),
    sim.getObject('/UR5/link/joint/link/joint/link/joint/link/joint/link/joint')
]
...
for i, joint_handle in enumerate(ur5_joints, start=1):
    position = sim.getJointPosition(joint_handle)
    print(f"Joint {i}: "f"{np.rad2deg(position):.2f} degrees")
